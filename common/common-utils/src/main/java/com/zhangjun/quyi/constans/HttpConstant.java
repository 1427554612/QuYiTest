...
public interface HttpConstant {
    ...
    public static final String REQUEST_HEADER_CONTENT_DISPOSITION = "Content-Disposition";
    public static final String REQUEST_HEADER_CONTENT_LENGTH = "Content-length";

    public static final String MIME_TYPE_HTML = "text/html";

    public static final String RESPONSE_STR_DATA = "data";
    public static final String RESPONSE_STR_LIST = "list";
